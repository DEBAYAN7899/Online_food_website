...
<div class="main-content">
    <div class="wrapper">
        ...
        <a class="btn btn-primary" href="add-admin.php" role="button">Add Admine</a>
            <br><br>
                        ...
                        while($rows=mysqli_fetch_assoc($res))
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo SITEURL; ?>admin/delete-admin.php?id=<?php echo $id; ?>" class="btn-den">Delete Admin</a>
                                </td>
                            </tr>
                            <?php
                        }
